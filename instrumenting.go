...
func (mw instrmw) Movies(s map[string]interface{}, ctx context.Context) (output map[string]interface{}, err error) {
	defer func(begin time.Time) {
		lvs := []string{"method", "movies", "error", fmt.Sprint(err != nil)}
